/*
Author       : Dreamguys
Template Name: AidXpert - Bootstrap Template
Version      : 1.3
*/
	...
	if($('#more-view2').length > 0 ) {
		...
		function showMoreLess() {
		  if (isLess) {
			...
			button.innerHTML = "Show less <i className='feather-chevrons-right ms-1'>";
		  } else {
			isLess = true;
			container.style.height = '100px';
			button.innerHTML = "Show more <i className='feather-chevrons-right ms-1'></i>";
		  }
		}
